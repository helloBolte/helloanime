      ...
      <CardContent className="space-y-4">
        {isLoading
          ...
          : data?.Page.media.map((anime) => (
              <div
                key={anime.id}
                className="flex gap-3 hover:bg-accent/50 p-2 rounded-lg transition-colors cursor-pointer"
              >
                <img
                ...
                <div className="flex flex-col justify-between py-1">
                  <h4 className="font-medium line-clamp-2">{anime.title.userPreferred}</h4>
